...
class GradientAppendAttack():
    ...
    def update_bytes(self, bytez, bytez_len, gradient, result):
    ...
    def do_attack(self, bytez, bytez_len):
        for i in range(self.iter_num):
            ...
            grads = embed.grad
            self.update_bytes(bytez, bytez_len, grads, result)
